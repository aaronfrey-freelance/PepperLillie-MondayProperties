...
if(!defined('WPFB'))
{
	...
	define('WPFB_PLUGIN_NAME', 'WP-Filebase Pro');
	define('WPFB_SUPPORT_EMAIL', 'sup@wpfilebase.com');
...
if(isset($wpdb))
{
	...
	$wpdb->wpfilebase_rsync_meta = $wpdb->prefix . 'wpfb_rsync_meta';
}
