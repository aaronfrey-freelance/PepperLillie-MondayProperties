...
private static function apiRequest($act, $post_data=null, $use_ssl=true) {
	...
	$get_args = array('version' => WPFB_VERSION, 'pl_slug' => 'wp-filebase-pro','pl_ver'=> WPFB_VERSION, 'wp_ver' => $wp_version ,'license_key' => $license_key, 'key' => $license_key , 'site' => $site);
...
static function PluginDeactivated()
{
	...
	return self::apiRequest('disable-site');
}
}