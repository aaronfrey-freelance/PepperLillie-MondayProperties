...
-->
	<div class="" style="float: left;">	
		...
		<label title="<?php _e('No') ?>"><input type="radio" name="file_direct_linking" value="2" /> <?php _e('Redirect to File Page', WPFB) ?></label>
...
<!--
	...
	<div class="form-field">		
		<label><?php _e('Access Permissions',WPFB) ?></label>
		<div id="file_perm_wrap">
			<div id="file_user_roles"><?php WPFB_Admin::UserSelector('file_owner', null, _e('&mdash; No Change &mdash;' ) ) ?></div>
		</div>
	</div>
...
-->
	...
	<div class="form-field">		
		<label for="<?php echo $prefix; ?>file_password"><?php _e('Password') ?></label>
		<input id="<?php echo $prefix; ?>file_password" name="file_password" type="text" placeholder="<?php _e('&mdash; No Change &mdash;' ); ?>" />
	</div>
