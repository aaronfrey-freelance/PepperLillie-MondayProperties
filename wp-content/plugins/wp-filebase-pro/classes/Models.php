...
static function TplVarsDesc($for_cat=false)
{
	...
	'cat_zip_url'			=> __('URL to a ZIP File containing all accessible files in this category'),
	...
	'file_page_url'			=> sprintf(__('URL to Details Page (see template \'%s\')', WPFB), 'filepage'),
	...
	'file_sec_cats'			=> __('List of secondary categories', WPFB),
