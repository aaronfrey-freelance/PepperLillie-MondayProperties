<?php class WPFB_AttachUploader {	
	public static function ReturnHTML($post_id, $tpl_tag) {
		ob_start(); self::RenderHTML($post_id, $tpl_tag); return ob_get_clean();
	}
...
<div id="<?php echo $container_id; ?>" class="wpfb-attach-uploader" style="display:none;"><?php _e('Drop files here to attach or'); ?>
...
jQuery('#<?php echo $container_id; ?>').hide()
		  .parent()
				...
				.bind('drop', function(){	jQuery('#<?php echo $container_id; ?>').hide(); });
