<?php class WPFB_WidgetForms {
	public static function UploadWidget($obj, $instance ) {
		...
		?><div>
			...
			<p><label for="<?php echo $obj->get_field_id('category'); ?>"><?php !empty(WPFB_Core::$settings->category_substitute)?print(esc_html(WPFB_Core::$settings->category_substitute)):_e('Category:'); ?>
	...
	<div>
		...
		<!-- TODO multi cat -->
		<p><label for="<?php echo $obj->get_field_id('cat'); ?>"><?php !empty(WPFB_Core::$settings->category_substitute)?print(esc_html(WPFB_Core::$settings->category_substitute)):_e('Category:', WPFB); ?>
