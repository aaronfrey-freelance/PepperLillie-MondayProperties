...
static function CatRow($cat, $sub_level=0)
{
	...
	?>
			<tr id="cat-<?php echo $cat_id; ?>">
				...
				<td><?php echo WPFB_Output::RoleNames($cat->GetWritePermissions() ,true) ?></td>
...
static function Display()
{
	...
	switch($action)
	{
		...
		default:				
			...
			{
				if ( !WPFB_Core::CheckPermission('delete_cat') )
	...
	<form id="posts-filter" action="" method="post">
		...
		<table class="widefat">
			...
			<tr>
				...
				<th scope="col"><a href="<?php echo WPFB_Admin::AdminTableSortLink('cat_upload_permissions') ?>"><?php _e('Upload Permission',WPFB) ?></a></th>		
