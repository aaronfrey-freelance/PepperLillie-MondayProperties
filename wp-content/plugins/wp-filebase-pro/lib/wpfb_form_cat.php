...
<?php wp_nonce_field($nonce_action, 'wpfb-cat-nonce'); ?>
	<table class="form-table">
		...
		<tr>
			<th scope="row" valign="top"><label for="cat_upload_permissions"><?php _e('Upload Permission',WPFB) ?></label></th>
			<td>
				...
				<?php _e('Set which users are allowed to upload to this category.',WPFB)?>
			</td>
		</tr>
