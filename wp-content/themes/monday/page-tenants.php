<?php while (have_posts()) : the_post(); ?>
	...
	<div class="mainwhite" align="center">
		...
		<div class="maincontent">
			...
			<div class="container">
				...
				<div class="row no-gutter tenantrow">

					<div class="col-xs-12 col-sm-6 col-md-3 tenant">
	...
	<div id="slides">
		<ul class="slides-container">    
			<li><img src="<?php bloginfo('template_url'); ?>/dist/images/tenants.jpg" class="img-responsive"></li>
			<li><img src="<?php bloginfo('template_url'); ?>/dist/images/tenants.jpg" class="img-responsive"></li>
		</ul>
	</div>
